...
% PHYMODEL类定义物理层参数
% modulation - will be used to calculate BER 将用于计算误码率
% bitrate - will be used to compute duration in TX state 将用于计算TX状态下的持续时间
% coding - channel coding rate 信道编码率
% Pt - transmit power, dBm 发射功率
% Pr - receiver sensitivity, dBm 接收机灵敏度
% Gt - transmit antenna gain, dBi 发射天线增益
% Gr - receive antenna gain, dBi 接收天线增益
% L - other losses, dB
% Fade - fade margin, dB 衰落储备
